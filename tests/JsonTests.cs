...
namespace tests
{
    ...
    public class JsonTests
    {
        ...
        public void SerializeResponse()
        {
            ...
            var serialized = FaasSerializationHelpers<Response>.Serialize(response);
        ...
        public void DeserializeResponse()
        {
            ...
            var deserialized = FaasSerializationHelpers<Response>.Deserialize(responseString);
        ...
        public void SerializeEvent()
        {
            ...
            var serialized = FaasSerializationHelpers<Event>.Serialize(eve);
            Assert.IsFalse(string.IsNullOrEmpty(serialized));
        ...
        public void DeserializeEvent()
        {
            ...
            var deserialized = FaasSerializationHelpers<Event>.Deserialize(eventsString);
            Assert.IsNotNull(deserialized);
